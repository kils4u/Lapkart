...
@WebServlet(urlPatterns = {"/small_offers"})
public class small_offers extends HttpServlet {
    
    String query = "select * from offer where off_id IN (select offer_id from small_offers)";
